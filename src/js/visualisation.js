...
function showResults(results) {
  ...
  var resultDiv = document.createElement("div"),
      ...
      tourLengthLabel = document.createTextNode(`Длинна маршрута: `),
      ...
      elapsedTimeLabel = document.createTextNode(`Время выполнения: `),
      ...
      tourText = document.createTextNode(`Маршрут: `),
      tour,

      showTourButtonWrapper = document.createElement("div"),
      showTourButton = document.createElement("button"),
      showTourButtonText = document.createTextNode(`Показать маршрут`),
...
function solveWithNearestNeighbour() {
  ...
  result.algName = "Алгоритм ближайшего соседа";
  result.elapsedTime = t1 - t0;
  result.id = resultsCount++;
  showResults(result);

  currentAlgorithm = "nearestNeighbour";
  document.getElementById("currentAlgorithm").innerHTML = "<b>Алгоритм ближайшего соседа</b>";
  clearElementChildren("pseudocode");
...
function solveWithBranchAndBound() {
  ...
  let t1 = performance.now();
  result.algName = "Алгоритм ветвей и границ";
  result.elapsedTime = t1 - t0;
  result.id = resultsCount++;
  showResults(result);

  currentAlgorithm = "branchAndBound";
  document.getElementById("currentAlgorithm").innerHTML = "<b>Алгоритм ветвей и границ</b>";
  clearElementChildren("pseudocode");
  document.getElementById("stepCounter").hidden = false;
  document.getElementById("totalSteps").innerHTML = stepsTaken.length;
  document.getElementById("currentStep").innerHTML = "0";
...
function solveWithBruteForce() {
  ...
  let t1 = performance.now()
  result.algName = "Полный перебор";
  result.elapsedTime = t1 - t0;
  result.id = resultsCount++;
  showResults(result);

  currentAlgorithm = "bruteForce";
  document.getElementById("currentAlgorithm").innerHTML = "<b>Полный перебор</b>";
  clearElementChildren("pseudocode");
  document.getElementById("stepCounter").hidden = false;
  document.getElementById("totalSteps").innerHTML = stepsTaken.length;
  document.getElementById("currentStep").innerHTML = "0";
...
function solveWithApproxMinSpanTree() {
  ...
  let t1 = performance.now();
  result.algName = "Алгоритм минимального оставного дерева";
  result.elapsedTime = t1 - t0;
  result.id = resultsCount++;
  showResults(result);

  currentAlgorithm = "approxMinSpanTree";
  document.getElementById("currentAlgorithm").innerHTML = "<b>Алгоритм минимального оставного дерева</b>";
  clearElementChildren("pseudocode");
  document.getElementById("stepCounter").hidden = false;
  document.getElementById("totalSteps").innerHTML = stepsTaken.length;
  document.getElementById("currentStep").innerHTML = "0";
...
function solveWithChristofides() {
  ...
  let t1 = performance.now();
  result.algName = "Алгоритм Кристофайдеса";
  result.elapsedTime = t1 - t0;
  result.id = resultsCount++;
  showResults(result);

  currentAlgorithm = "christofides";
  document.getElementById("currentAlgorithm").innerHTML = "<b>Алгоритм Кристофайдеса</b>";
  clearElementChildren("pseudocode");
  document.getElementById("stepCounter").hidden = false;
  document.getElementById("totalSteps").innerHTML = stepsTaken.length;
  document.getElementById("currentStep").innerHTML = "0";
...
function solveWithIntegerProgrammingDFJ() {
  ...
  let t1 = performance.now();
  result.algName = "Алгоритм линейного программирования(Д-Ф-Д)";
  result.elapsedTime = t1 - t0;
  result.id = resultsCount++;
  showResults(result);

  currentAlgorithm = "ipdfj";
  document.getElementById("currentAlgorithm").innerHTML = "<b>Алгоритм линейного программирования(Д-Ф-Д)</b>";
  clearElementChildren("pseudocode");
  document.getElementById("stepCounter").hidden = false;
  document.getElementById("totalSteps").innerHTML = stepsTaken.length;
  document.getElementById("currentStep").innerHTML = "0";
...
function solveWithIntegerProgrammingMTZ() {
  ...
  let t1 = performance.now();
  result.algName = "Алгоритм линейного программирования(М-Т-З)";
  result.elapsedTime = t1 - t0;
  result.id = resultsCount++;
  showResults(result);

  currentAlgorithm = "ipmtz";
  document.getElementById("currentAlgorithm").innerHTML = "<b>Алгоритм линейного программирования(М-Т-З)</b>";
  clearElementChildren("pseudocode");
  document.getElementById("stepCounter").hidden = false;
  document.getElementById("totalSteps").innerHTML = stepsTaken.length;
  document.getElementById("currentStep").innerHTML = "0";
